...
public class ShiroConfig {
   ...
   @Bean
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(){
        ...
        map.put("/account/changePassword", "anon");
        map.put("/account/pickcoursev", "anon");
        map.put("/account/evaluation", "anon");
        map.put("/account/information", "anon");
        map.put("/account/achievements", "anon");
        map.put("/common/dashboard", "anon");
        map.put("/by/getStudentById/**", "anon");
        map.put("/by/studentByPId/**", "anon");
        map.put("/by/StudentBySId/**", "anon");
        map.put("/by/achievements/**", "anon");
        map.put("/by//by/getTectBookBySId/**", "anon");
